...
DEFCE="`edg-brokerinfo getCE | head -n 1 | awk '{ print $1}' | cut -d: -f 1`"
DEFSE="`edg-brokerinfo getCloseSEs | head -n 1 | awk '{ print $1}'`"
HOST=`/bin/hostname`
...
echo "======================================================================"
chmod +x $PWD/gbb
$PWD/gbb -v -m 300 -p -s grid-cert-03.roma1.infn.it -D 600 /bin/ls $VO_ATLAS_SW_DIR
$PWD/gbb -v -m 300 -p -s grid-cert-03.roma1.infn.it -D 600 /bin/du -sk $VO_ATLAS_SW_DIR/*
echo "======================================================================"
